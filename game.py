...
def move_character(event):
    ...
    if event.char == "d": #move the character to the right
        X = X + 25
        print (str(X) + " , " + str(Y))
        char_canvas.place(width = 50, height= 50, x = X, y = Y)
        char_canvas.update()

    if event.char == "w": #move the character up
        Y = Y - 25
        print (str(X) + " , " + str(Y))
        char_canvas.place(width = 50, height= 50, x = X, y = Y)
        char_canvas.update()
    ...
    if event.char == "s": #move the character down
        Y = Y + 25
        print (str(X) + " , " + str(Y))
        char_canvas.place(width = 50, height= 50, x = X, y = Y)
        char_canvas.update()

    if event.char == "p": #print stop
        print ("stop")

    if event.char == "l": # to start the game
        stage_0()
        window.unbind("<l>")

    if event.char == "k": # cheat code to increase the score
        score += 10
        txt = "score:" + str(score)
...
def stage_0():
    ...
    canvas.update()
    if X <= 25 or X >= 625 or Y <= 25 or Y >= 625 or (Y >= 225 and Y <= 425 ): # checks for overlapping between the character and the lava
        print("lost")
        lose_game()
...
def stage_1():
    ...
    canvas.update()
    if X <= 25 or X >= 625 or Y <= 25 or Y >= 625 or ( Y >= 125 and Y <= 225) or ( Y >= 325 and Y <= 425) or (Y >= 525): # checks for overlapping
        print("lost")
        lose_game()
...
def stage_2():
    ...
    if X <= 25 or X >= 625 or Y <= 125 or Y >= 625 or ( Y >= 225 and Y <= 325) or (Y >= 425 and Y <= 525): # checks for overlapping
        print("lost")
        lose_game()
...
def stage_3():
    ...
    if X <= 25 or X >= 625 or Y <= 25 or Y >= 625 or (X <= 325 and Y <= 325 ) or (X >= 325 and Y >= 325 ): # checks for overlapping
        print("lost")
        lose_game()
    canvas.after(1000 - time)
    canvas.move(block_a1,-2000,-2000)
...
def stage_4(): # stage 4 of the game
    ...
    if X <= 25 or X >= 625 or Y <= 25 or Y >= 625 or ( X <= 425 and X >= 225): # checks for overlapping
        print("lost")
        lose_game()
    canvas.after(1000 - time)
    canvas.move(block_c1,-2000,-2000)
...
def stage_5(): # stage 5 of the game
    ...
    txt = "score:" + str(score)
    canvas.itemconfigure(score_text, text=txt)
    time += 250 # reduce the delay between stages
    canvas.move(block_a6,2000,2000)
    canvas.move(block_b6,2000,2000)
    canvas.move(block_c6,2000,2000)
    ...
    if X <= 25 or X >= 625 or Y <= 25 or Y >= 625 or (X >= 325 and Y <= 325 ) or (X <= 325 and Y >= 325 ): # check for overlapping
        print("lost")
        lose_game()
    canvas.after(1000 - time)
    canvas.move(block_a6,-2000,-2000)
...
def default():
    ...
    window.bind("<Escape>", move_character)
    window.mainloop()
